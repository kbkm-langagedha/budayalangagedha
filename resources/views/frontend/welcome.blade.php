...
@section('description', 'Jelajahi keindahan warisan budaya Langagedha dari Nusa Tenggara Timur. Tempat dimana tradisi, kesenian, dan kearifan lokal tetap hidup dan terjaga.')
                ...
                @foreach ($images as $image)
                    <div class="swiper-slide">
                        <div class="swiper-inner"
                             data-bgimage="url('{{ Storage::url($image->image) }}')">
                ...
                <div class="custom-calendar bg-blur rounded-3 p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="small px-3 py-1 rounded"
                            style="background: rgba(240, 227, 192, 0.3);">{{ date('Y') }}</div>
                    </div>
