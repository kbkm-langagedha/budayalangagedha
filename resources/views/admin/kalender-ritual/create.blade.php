...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('kalender-ritual.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nama_ritual" class="form-label">Nama Ritual <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('nama_ritual') is-invalid @enderror" id="nama_ritual" name="nama_ritual" value="{{ old('nama_ritual') }}" required>
                                    @error('nama_ritual')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="1" max="31" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ old('tanggal') }}" required>
                                    @error('tanggal')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="mb-3">
                            <label for="gambar" class="form-label">Gambar Ritual <span class="text-danger">*</span></label>
